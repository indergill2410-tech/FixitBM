      ...
      <section className="container py-14">
        <Card className="max-w-2xl">
          ...
          <p className="mt-3 leading-7 text-[var(--text2)]">
            {isSuccess
              ? `${plan?.name ?? "Your selected plan"} is now being reconciled with your dashboard. If it does not update immediately, support can review the account from your billing reference.`
              : isCancelled
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Button href={isSuccess ? "/dashboard" : "/pricing"}>{isSuccess ? "Go to dashboard" : "View plans"}</Button>
