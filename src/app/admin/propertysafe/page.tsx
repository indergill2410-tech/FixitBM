                ...
                <div className="grid gap-5 xl:grid-cols-[1fr_380px]">
                  <div>
                    ...
                    {profile.latest_assessment_summary ? (
                      <p className="mt-5 rounded-xl border border-[var(--border)] bg-[var(--bg2)] p-4 text-sm leading-6 text-[var(--text2)]">
                        {profile.latest_assessment_summary}
                      </p>
                    ) : (
                      <p className="mt-5 rounded-xl border border-[var(--border)] bg-[var(--bg2)] p-4 text-sm leading-6 text-[var(--text2)]">
...
function Metric({ icon: Icon, label, value }: { icon: LucideIcon; label: string; value: string }) {
  return (
    <div className="rounded-xl border border-[var(--border)] bg-[var(--bg2)] p-4">
      ...
      <p className="mt-3 text-xs font-black uppercase tracking-wide text-[var(--text3)]">{label}</p>
