        ...
        <div className="mx-auto grid w-full max-w-6xl gap-6 lg:grid-cols-[.9fr_1fr] lg:items-start">
          <div className="pt-4">
            ...
            <h1 className="mt-5 text-4xl font-black leading-tight tracking-tight md:text-5xl">
              Create the agency workspace before the first property is shared.
            </h1>
            <p className="mt-5 max-w-xl text-lg leading-8 text-[var(--text2)]">
              Start with the agency record, then add managed properties, owner access, and maintenance rules. Owners see
              only what the agency chooses to share.
            </p>
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
              {["Agency controlled", "Owner visible", "Property records"].map((item) => (
          ...
          <Card>
            ...
            <p className="mt-3 text-sm leading-6 text-[var(--text2)]">
              This creates a dedicated agency account and the first PropertySafe agency backend record.
            </p>
            <AgencyRegisterForm />
          </Card>
        </div>
